...
class create_xml:
    ...
    def root_elements(self):
        ...
        workers = [['ЕВГЕНИЙ', 'ВЛАДИМИРОВИЧ', 'МОСКАЛЬКОВ', 'СПЕЦИАЛИСТ', 'паспорт', '2006-07-19', '2026-04-15'
                       , '296', '2006-08-02'],
                   ['ВЛАДИМИР', 'АНАТОЛЬЕВИЧ', 'ВОЛЧЁК', 'ВЕДУЩИЙ СПЕЦИАЛИСТ', 'паспорт', '2012-12-21', '2022-12-21'
                       , '144', '2018-09-27']
                   ]
